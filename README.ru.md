...
Я **Python-разработчик** с более чем **3 годами коммерческого опыта**. Основная специализация — **backend**, **боты**, **REST API**, **инфраструктура**, **e-commerce**, **SaaS**, **блокчейн** и **нейросети**.
